...
function renderDetails(id) {
  ...
  detail = `<div class='movie-detail-container'>
            <img src="${movies[index].thumbnail}"/>
            <div class='movie-detail'>
              <div class='movie-title'>${movies[index].title}</div>
              <div class='movie-year'>${movies[index].year}</div>
              <div class='movie-genres'>${movies[index].genres}</div>
              <p>${movies[index].extract}</p>
  ...
  backBtn.addEventListener('click', rendermovies)
}
